...
export const translations = {
  pl: {
    ...
    checkout: {
      ...
      orderButton: "Złóż zamówienie",
      namePlaceholder: "Twoje imię",
      commentPlaceholder: "Kody do drzwi, piętro itp.",
  ...
  en: {
    ...
    checkout: {
      ...
      commentPlaceholder: "Door codes, floor etc.",
      orderSuccess: "Order placed!",
      orderSuccessHint: "We will contact you shortly",
    },
  },
  uk: {
    ...
    checkout: {
      ...
      commentPlaceholder: "Коди до дверей, поверх тощо",
      orderSuccess: "Замовлення оформлено!",
      orderSuccessHint: "Ми зв'яжемося з вами найближчим часом",
    },
  },
  ru: {
    ...
    checkout: {
      ...
      commentPlaceholder: "Коды дверей, этаж и т.д.",
      orderSuccess: "Заказ оформлен!",
      orderSuccessHint: "Мы свяжемся с вами в ближайшее время",
    },
  },
} as const;
